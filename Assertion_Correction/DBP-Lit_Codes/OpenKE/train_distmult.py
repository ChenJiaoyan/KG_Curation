...
# con.set_import_files("./res_distmult_1/model.vec.tf")

#Models will be exported via tf.Saver() automatically.
con.set_export_files("./res_distmult_DBP/model.vec.tf", 0)
#Model parameters will be exported to json files automatically.
con.set_out_files("./res_distmult_DBP/embedding.vec.json")
